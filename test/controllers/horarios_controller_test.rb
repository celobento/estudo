...
class HorariosControllerTest < ActionController::TestCase
  ...
  test "should create horario" do
    assert_difference('Horario.count') do
      post :create, horario: { dia_semana: @horario.dia_semana, inicio: @horario.inicio, termino: @horario.termino }
    end
  ...
  test "should update horario" do
    patch :update, id: @horario, horario: { dia_semana: @horario.dia_semana, inicio: @horario.inicio, termino: @horario.termino }
    assert_redirected_to horario_path(assigns(:horario))
  end
